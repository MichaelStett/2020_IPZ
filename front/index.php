...
<body>
	<header class="position-sticky">
		<nav class="navbar navbar-expand-lg sticky-top">
			<a class="navbar-brand" href="#"><img src="img/Logo.png"></i> AppName</a>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col" id="searchedWeather"></div>
		</div>
				...
				<div id="adsCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img class="d-block w-100 h-50" src="img/ads/Jacket_Ad.png" alt=" First slide">
						...
						<div class="carousel-item">
							<img class="d-block w-100 h-50" src="img/ads/Umbrella_Ad.png" alt="Second slide">
							<div class="carousel-caption d-none d-md-block">
								<h5>Umbrella UMMY</h5>
						...
						<div class="carousel-item">
							<img class="d-block w-100 h-50" src="img/ads/Sunglasses_Ad.png" alt="Third slide">
							<div class="carousel-caption d-none d-md-block">
						...
						<div class="carousel-item">
							<img class="d-block w-100 h-50" src="img/ads/WateringCan_Ad.png" alt="Fourth slide">
							<div class="carousel-caption d-none d-md-block">
